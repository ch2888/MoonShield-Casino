  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <CardImage src="/images/degg.png" alt="Dragoneggfarm logo" width={64} height={64} />
        <Block>
          <Row>
            <Left>
              <PizzaHarvestBalance />
              <Label>{TranslateString(544, 'DEGG to Harvest')}</Label>
            </Left>
            <Right>
              <PizzaWalletBalance />
              <Label>{TranslateString(546, 'DEGG in Wallet')}</Label>
            </Right>
          </Row>
        </Block>
        <Actions>
