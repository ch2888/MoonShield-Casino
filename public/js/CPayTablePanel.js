function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        _oWildText = new createjs.Text(TEXT_HELP_WILD,"20px "+FONT_GAME, "#ffff00");
        _oWildText.textAlign = "center";
        _oWildText.lineWidth = 280;
        _oWildText.lineHeight = 22;
        _oWildText.x = 635;
        _oWildText.y = 284;
        _oContainer.addChild(_oWildText);
        
        _oBonusText = new createjs.Text(TEXT_HELP_BONUS,"20px "+FONT_GAME, "#ffff00");
        _oBonusText.textAlign = "center";
        _oBonusText.lineHeight = 22;
        _oBonusText.lineWidth = 250;
        _oBonusText.x = 1012;
        _oBonusText.y = 284;
        _oContainer.addChild(_oBonusText);

        _oPayline25Text = new createjs.Text("PAYLINES","20px "+FONT_GAME, "#ffff00");
        _oPayline25Text.textAlign = "center";
        _oPayline25Text.lineHeight = 22;
        _oPayline25Text.lineWidth = 250;
        _oPayline25Text.x = 720;
        _oPayline25Text.y = 400;
        _oContainer.addChild(_oPayline25Text);
    ...
    this._createPayouts = function(){
        ...
        var aPos = [{x:430,y:95},{x:650,y:95},{x:870,y:95},{x:1080,y:95},
                    {x:430,y:195},{x:650,y:195},{x:870,y:195},{x:1080,y:195}];
        var iCurPos = 0;
        for(var i=0;i<s_aSymbolWin.length;i++){
            ...
            for(var j=0;j<iLen;j++){
                var oTextMult = new createjs.Text("X"+(NUM_REELS-j),"25px "+FONT_GAME, "#ffffff");
