function CMenu(){
    ...
    this._init = function(){
        ...
        _oButPlay = new CTextButton((CANVAS_WIDTH/2),CANVAS_HEIGHT - 60,oSprite,TEXT_PLAY+"(Pay)",FONT_GAME,"#ffffff",28,s_oStage);
        _oButPlay.addEventListener(ON_MOUSE_UP, this._onButPaidPlay, this);

        oSprite = s_oSpriteLibrary.getSprite('but_play_bg');
        _oButFreePlay = new CTextButton((CANVAS_WIDTH/2),CANVAS_HEIGHT - 120,oSprite,TEXT_PLAY+"(Free)",FONT_GAME,"#ffffff",28,s_oStage);
        _oButFreePlay.addEventListener(ON_MOUSE_UP, this._onButFreePlay, this);
    ...
    this._onButFreePlay = function(){
        G_FREE_MODE = true;
        this._onButPlayRelease();
    };
    
    this._onButPaidPlay = function(){
        G_FREE_MODE = false;
        this._onButPlayRelease();
    };
