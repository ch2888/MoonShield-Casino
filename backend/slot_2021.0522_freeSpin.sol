...
contract Slot is SlotOwnable, Initializable {
    ...
    */
    ...
    function rollFreeSpin() public returns(uint256 nSpinCodes) {
        ...
        uint nCntSpins = rndHashShiftm%3;// 0=>12; 1 =>15, 2 => 21
        nCntSpins += 110; // identifier for SpinMode. 110+3
        result += nCntSpins;
        result *= nUnit;
    ...
    function getSpinCode(address useraddress) public view returns(uint256,uint256,uint256[21] memory arrayCode) {
        UserInfo storage user = userInfo[useraddress];
        ...
        arrayCode[2] = 345;
        arrayCode[3] = 45;
        return (user.nSpinCode,user.amount, arrayCode);
    }
